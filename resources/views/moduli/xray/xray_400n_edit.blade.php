    ...
    <form action="{{ route('editPost400N', ['idActivity' => $activity->Id_PrBLAttivita, 'id' => $id]) }}" method="POST"
        ...
        <table class="table table-bordered" id="myTable">
            ...
            <tbody>
                <tr id="referenceRow">
                    <td>
                        <span class="counter">1</span>° con. ore <input name="ore1" value="{{ $json->ore1 }}"
                    ...
                    <td>
                        <div class="form-check d-flex justify-content-center">
                            ...
                            <input name="fe1" type="checkbox" id="fe1"
                                class="custom-checkbox form-check-input" value="{{ $json->fe1 }}">
                        </div>
                    </td>
                    <td>
                        <div class="form-check d-flex justify-content-center">
            ...
            axios.get('/XWPCollo/{{ $activity->Id_PrBLAttivita }}')
                .then(function(response) {
                    ...
                    response.data.forEach(function(collo) {
                        ...
                        document.getElementById(`ceramic1`).checked = (document.getElementById(
                            `xceramic1`).value === "true") ? true : false;
                        document.getElementById(`crystal1`).checked = (document.getElementById(
                            `xcrystal1`).value === "true") ? true : false;
                        document.getElementById(`stainless1`).checked = (document.getElementById(
                            `xstainless1`).value === "true") ? true : false;
                        document.getElementById(`nofe1`).checked = (document.getElementById(`xnofe1`)
                            .value === "true") ? true : false;
                        document.getElementById(`fe1`).checked = (document.getElementById(`xfe1`)
                            .value === "true") ? true : false;
