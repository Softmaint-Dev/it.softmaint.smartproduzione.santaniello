         ...
         <div class="form-row">
             <div class="col-md-4 mb-3">
                 ...
                 <div class="input-group date">
                     <input type="text" class="form-control datepicker" id="data" name="data" readonly
                         required>
         ...
         <table class="table">
             ...
             <tbody>
                 <tr>
                     ...
                     <td>
                         <textarea name="allarme_nota" class="form-control" rows="3"></textarea>
                     </td>
                 </tr>
                 <tr>
                     ...
                     <td>
                         <textarea name="ricetta_nota" class="form-control" rows="3"></textarea>
                     </td>
                 </tr>
                 <tr>
                     ...
                     <td>
                         <textarea class="form-control" name="filtro_acqua_note" rows="3"></textarea>
                     </td>
                 </tr>
                 <tr>
                     ...
                     <td>
                         <textarea class="form-control" name="elettrovalvole_note" rows="3"></textarea>
                     </td>
                 </tr>
                 <tr>
                     ...
                     <td>
                         <textarea class="form-control" name="calibrazione_note" rows="3"></textarea>
                     </td>
                 </tr>
             </tbody>
         </table>
