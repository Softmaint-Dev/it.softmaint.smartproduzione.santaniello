...
<form class="mt-5" action="{{ route('createPostEfficienza', ['id' => $attivity->Id_PrBLAttivita]) }}" method="POST"
    ...
    <div class="container mt-5">
        <h2>Tabella Funzionamento SEA HYPERSORT</h2>
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <div class="form-check form-switch">
                            <input required name="allarme" class="form-check-input required" type="checkbox" role="switch"
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-check form-switch">
                            <input required name="ricetta" class="form-check-input required" type="checkbox" role="switch"
                                id="flexSwitchCheckChecked" checked>
                         </div>
                    </td>
               ...
               <tr>
                    ...
                    <td>
                        <div class="form-check form-switch">
                            <input required name="filtro_acqua" class="form-check-input required" type="checkbox" role="switch"
                                id="flexSwitchCheckChecked" checked>
                         </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-check form-switch">
                            <input required name="elettrovalvole" class="form-check-input required" type="checkbox" role="switch"
                                id="flexSwitchCheckChecked" checked>
                         </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-check form-switch">
                            <input required name="calibrazione" class="form-check-input required" type="checkbox" role="switch"
                                id="flexSwitchCheckChecked" checked>
                         </div>
                    </td>
