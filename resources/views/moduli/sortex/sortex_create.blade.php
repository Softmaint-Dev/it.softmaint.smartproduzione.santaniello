...
<form class="mt-5" action="{{ route('createPostSortex', ['id' => $attivity->Id_PrBLAttivita]) }}" method="POST"
        ...
        <div class="form-row">
            ...
            <div class="col-md-4 mb-3">
                <div class="mb-3">
                    ...
                    <input required type="text"  name="varieta" name="sampleCalibratura" class="form-control" id="caliberSample"
                        aria-describedby="emailHelp">
                </div>
            </div>
        </div>
