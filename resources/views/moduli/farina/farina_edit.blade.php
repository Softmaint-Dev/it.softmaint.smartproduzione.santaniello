        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    @include('moduli.farina.components.analysis_time', ['name' => 'analysisTime','value' => $json->analysisTime])

                    @include('moduli.farina.components.sample', ['name' => 'sample','value' => $json->sample])
                        ...
                        <div class="mb-3">
                            <div class="container mt-5">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>color / colore</td>
                                        <td><input type="text" name="colorNatural" id="colorNatural"
                                                   value="{{$json->colorNatural}}" class="form-control"></td>
                                        <td><input type="text" name="colorRoasted" id="colorRoasted"
                                                   value="{{$json->colorRoasted}}" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>taste and smell</td>
                                        <td><input type="text" name="tasNatural" id="tasNatural"
                                                   value="{{$json->tasNatural}}" class="form-control"></td>
                                        <td><input type="text" name="tasRoasted" id="tasRoasted"
                                                   value="{{$json->tasRoasted}}" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>total</td>
                                        <td><input type="text" name="totalNatural" id="totalNatural"
                                                   value="{{$json->totalNatural}}" class="form-control"></td>
                                        <td><input type="text" name="totalRoasted" id="totalRoasted"
                                                   value="{{$json->totalRoasted}}" class="form-control"></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="mb-3">
                            <div class="container mt-5">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>>2</td>
                                        <td><input type="text" name="value1" value="{{$json->value1}}" id="value1"
                                                   class="form-control"
                                                   oninput="updateCalculations()"></td>
                                        <td><input type="text" name="value1Percentage" id="value1Percentage"
                                                   value="{{$json->value1Percentage}}"
                                                   class="form-control" readonly></td>
                                    </tr>
                                    <tr>
                                        <td>>1</td>
                                        <td><input type="text" name="value2" value="{{$json->value2}}" id="value2"
                                                   class="form-control"
                                                   oninput="updateCalculations()"></td>
                                        <td><input type="text" name="value2Percentage" id="value2Percentage"
                                                   value="{{$json->value2Percentage}}"
                                                   class="form-control" readonly></td>
                                    </tr>
                                    <tr>
                                        <td>&lt;1</td>
                                        <td><input type="text" name="value3" value="{{$json->value3}}" id="value3"
                                                   class="form-control"
                                                   oninput="updateCalculations()"></td>
                                        <td><input type="text" name="value3Percentage" id="value3Percentage"
                                                   value="{{$json->value3Percentage}}"
                                                   class="form-control" readonly></td>
                                    </tr>
                                    <tr>
                                        <td>total</td>
                                        <td><input type="text" name="valueTot" id="valueTot" class="form-control"
                                                   value="{{$json->valueTot}}"
                                                   readonly></td>
                                        <td><input type="text" name="valueTotPercentage" id="valueTotPercentage"
                                                   value="{{$json->valueTotPercentage}}"
                                                   class="form-control" readonly></td>
                                    </tr>
                                    </tbody>
                                </table>
