                        ...
                        <div class="container mt-5">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="overSize" name="overSize"
                                                   value="{{ $json->overSize }}" required>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="calculation" name="calculation"
                                                   required value="{{ $json->calculation }}">
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="underSize" name="underSize"
                                                   required value="{{ $json->underSize }}">
                                        </div>
                                    </td>
                    ...
                    <div class="mb-3">
                        <div class="form-floating">
                            <textarea name="observations" class="form-control" placeholder="Leave a comment here"
                                      id="floatingTextarea2" style="height: 300px">{{$json->observations}}</textarea>
