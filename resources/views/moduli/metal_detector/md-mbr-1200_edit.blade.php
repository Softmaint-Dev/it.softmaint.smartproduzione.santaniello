                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-check d-flex justify-content-center">
                                    ...
                                    <input name="fe${num}" type="checkbox" id="fe${num}" class="custom-checkbox form-check-input" ${jsonArray['fe' + num] === 'true' ? 'checked' : ''}>
                                </div>
                            </td>
                            <td>
                                <div class="form-check d-flex justify-content-center">
                                    <input type="hidden" name="nofe${num}" value="false">
                                    <input name="nofe${num}" type="checkbox" id="nofe${num}" class="custom-checkbox form-check-input" ${jsonArray['nofe' + num] === 'true' ? 'checked' : ''}>
                                </div>
                            </td>
                            <td>
                                <div class="form-check d-flex justify-content-center">
                                    <input type="hidden" name="stainless${num}" value="false">
                                    <input name="stainless${num}" type="checkbox" id="stainless${num}" class="custom-checkbox form-check-input" ${jsonArray['stainless' + num] === 'true' ? 'checked' : ''}>
                                </div>
                            </td>
                        </tr>
                    `;
