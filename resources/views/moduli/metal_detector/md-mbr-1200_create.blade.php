...
<body>
    <form action="{{ route('createPostMDMBR1200', ['id' => $attivity->Id_PrBLAttivita]) }}" method="POST"
        class="container mt-5">  <div class="mb-3">
        ...
        <table class="table table-bordered" id="myTable">
            ...
            <tbody>
                <tr id="referenceRow">
                    <td>
                        <span class="counter">1</span>° con. ore <input name="ore1" id="ore1" type="text"
                        ...
                        <option value="" disabled selected>Seleziona un lotto</option>
                            ...
                            <input  type="text" id="xwpCollo" name="lotto1">
                        </div> --}}

                        <div class="mb-3">
                            <label for="caliber" class="form-label">LOTTO</label>
                    ...
                    <td>
                        ...
                        <div class="mb-3">
                            <label for="xwpCollo" class="form-label">LOTTO</label>
                             ...
                             <input type="text" name="lotto${counter}" name="sampleCalibratura" class="form-control"
                                id="lotto${counter}" aria-describedby="emailHelp">
                        </div>
                        @csrf
